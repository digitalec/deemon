...
## Create a New Task
![task-scheduler-1]({{ site.url }}/img/win-setup-1.png)

Inside Task Scheduler, select the **Action** menu button and click _Create Task..._


## Name the Task
![task-scheduler-2]({{ site.url }}/img/win-setup-2.png)
...
## Setup the Schedule
![task-scheduler-3]({{ site.url }}/img/win-setup-3.png)
...
![task-scheduler-4]({{ site.url }}/img/win-setup-4.png)
...
![task-scheduler-5]({{ site.url }}/img/win-setup-5.png)
